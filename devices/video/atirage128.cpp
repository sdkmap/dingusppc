...
static const std::map<uint16_t, std::string> rage128_reg_names = {
    {0x0000, "ATI_MM_INDEX"},
    {0x0004, "ATI_MM_DATA"},
    {0x0008, "ATI_CLOCK_CNTL_INDEX"},
    {0x000C, "ATI_CLOCK_CNTL_DATA"},
    {0x0010, "ATI_BIOS_0_SCRATCH"},
    {0x0014, "ATI_BIOS_1_SCRATCH"},
    {0x0018, "ATI_BIOS_2_SCRATCH"},
    {0x001C, "ATI_BIOS_3_SCRATCH"}
    {0x0030, "ATI_BUS_CNTL"},
    {0x0034, "ATI_BUS_CNTL1"},
    {0x0040, "ATI_GEN_INT_CNTL"},
    {0x0044, "ATI_GEN_INT_STATUS"},
    {0x0050, "ATI_CRTC_GEN_CNTL"},
    {0x0054, "ATI_CRTC_EXT_CNTL"},
    {0x0058, "ATI_DAC_CNTL"},
    {0x005C, "ATI_CRTC_STATUS"},
    {0x0068, "ATI_GPIO_MONID"},
    {0x006C, "ATI_SEPROM_CNTL"},
    {0x0094, "ATI_I2C_CNTL_1"},
    {0x00B0, "ATI_PALETTE_INDEX"},
    {0x00B4, "ATI_PALETTE_DATA"},
    {0x00E0, "ATI_CONFIG_CNTL"},
    {0x00F0, "ATI_GEN_RESET_CNTL"},
    {0x00F4, "ATI_GEN_STATUS"},
    {0x00F8, "ATI_CNFG_MEMSIZE"},
    {0x0130, "ATI_HOST_PATH_CNTL"},
    {0x0140, "ATI_MEM_CNTL"},
    {0x0144, "ATI_EXT_MEM_CNTL"},
    {0x05D0, "ATI_GUI_STAT"},
};
...
ATIRage128::ATIRage128(uint16_t dev_id) : PCIDevice("ati-rage128"), VideoCtrlBase(640, 480) {
    ...
    this->pci_notify_bar_change = [this](int bar_num) { this->notify_bar_change(bar_num); };
